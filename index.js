...
(function($PS) {
  ...
  var listItem = function (props) {
      var $11 = Halogen_HTML_Elements.li(Data_Semigroup.append(Data_Semigroup.semigroupArray)(props)([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.listGroupItem) ]));
      return function ($12) {
          return ListItem($11($12));
      };
  };
  var listItem_ = listItem([  ]);
  var listGroupC = function (classes) {
      var $13 = Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)(classes)([ Halogen_Themes_Bootstrap4.listGroup, Halogen_Themes_Bootstrap4.listGroupFlush ])) ]);
      var $14 = Data_Functor.map(Data_Functor.functorArray)(Data_Newtype.unwrap(newtypeListItem));
      return function ($15) {
          return $13($14($15));
      };
  };
  var listGroup = (function () {
      var $16 = Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.listGroup, Halogen_Themes_Bootstrap4.listGroupFlush ]) ]);
      var $17 = Data_Functor.map(Data_Functor.functorArray)(Data_Newtype.unwrap(newtypeListItem));
      return function ($18) {
          return $16($17($18));
      };
  })();                                                                      
  ...
  var languages = categoryHidden("languages")("Languages")([ listGroupC([ Halogen_Themes_Bootstrap4.textLeft ])([ listItem_([ Halogen_HTML_Core.text("French") ]), listItem_([ Halogen_HTML_Core.text("English") ]), listItem_([ Halogen_HTML_Core.text("Japanese") ]) ]) ]);
