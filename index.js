...
(function($PS) {
  ...
  var cite = function (v) {
      ...
      throw new Error("Failed pattern match at Content.Skills (line 418, column 1 - line 418, column 50): " + [ v.constructor.name ]);
  };
  var quote = function (v) {
      return function (content) {
          ...
          throw new Error("Failed pattern match at Content.Skills (line 423, column 1 - line 423, column 81): " + [ v.constructor.name, content.constructor.name ]);
      };
  };
  ...
  })([ new Data_Tuple.Tuple("purescript", purescript), new Data_Tuple.Tuple("elm", elm), new Data_Tuple.Tuple("cpp", cpp), new Data_Tuple.Tuple("haskell", haskell), new Data_Tuple.Tuple("c", c), new Data_Tuple.Tuple("lua", lua), new Data_Tuple.Tuple("js", javascript), new Data_Tuple.Tuple("csharp", csharp), new Data_Tuple.Tuple("coffeescript", coffeescript), new Data_Tuple.Tuple("ruby", ruby), new Data_Tuple.Tuple("python", python), new Data_Tuple.Tuple("html", html), new Data_Tuple.Tuple("css", css) ])) ]);
...
(function($PS) {
  ...
  var personalInformation = (function () {
      ...
      var dl = Halogen_HTML_Elements.a([ Halogen_HTML_Properties.title("Download"), Halogen_HTML_Properties.href("resume.pdf"), Halogen_HTML_Properties.download("download"), mkClass("download"), Halogen_HTML_CSS.style(linkStyle) ])([  ]);
      ...
      return Category.category("personal")("Sylvain Leclercq")([ Lists.listGroup([ Lists.listItem([ Halogen_HTML_CSS.style(css) ])(Data_Array.snoc(Data_Functor.map(Data_Functor.functorArray)(socialMedia)(medias))(dl)) ]) ]);
  })();
...
(function($PS) {
  ...
  var mkProject = function (pro) {
      var iconDiv = Data_Maybe.maybe(Halogen_HTML_Core.text(""))(function (language) {
          return Assets.iconS(language)([ Halogen_HTML_Properties.class_("projectIcon") ]);
      })(Control_Bind.bind(Data_Maybe.bindMaybe)(pro.language)(Data_Function.flip(Data_Map_Internal.lookup(Data_Ord.ordString))(icons)));
      return Lists.listItem_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.row) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.col1) ])([ iconDiv ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.col) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(pro.html_url) ])([ Halogen_HTML_Core.text(pro.name) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.col) ])([ Format.para(Data_Maybe.fromMaybe("")(pro.description)) ]) ]) ]);
  };
  var projects = function (v) {
      ...
      if (v instanceof Data_Maybe.Just) {
          ...
          var decodeThenMk = (function () {
              var $3 = Data_Either.either(mkErrorMsg)(Data_Functor.map(Data_Functor.functorArray)(mkProject));
              return function ($4) {
                  return $3(jsonToProject($4));
              };
          })();
          var parsed = Data_Argonaut_Parser.jsonParser(v.value0);
      ...
      throw new Error("Failed pattern match at Projects (line 67, column 1 - line 67, column 52): " + [ v.constructor.name ]);
  };
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Affjax.get(Affjax_ResponseFormat.string)("https://api.github.com/users/de-passage/repos?sort=updated")))(function (response) {
              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(function ($6) {
