          ...
          return function (title) {
              return function (content) {
                  ...
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.card) ])([ Halogen_HTML_Elements.a([ Attributes.collapseAttr, Halogen_HTML_Properties.href("#" + collapseId), Halogen_HTML_Properties_ARIA.role("button"), Halogen_HTML_Properties_ARIA.expanded((function () {
                      ...
                      return "false";
                  })()), Halogen_HTML_Properties_ARIA.controls(collapseId), Halogen_HTML_CSS.style(categoryTitleStyle) ])([ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.cardHeader, "caret", Halogen_Themes_Bootstrap4.alignBottom ]) ])([ Halogen_HTML_Core.text(title) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes((function () {
                      if (b) {
                          return [ Halogen_Themes_Bootstrap4.collapse, Halogen_Themes_Bootstrap4.show ];
                      };
                      return [ Halogen_Themes_Bootstrap4.collapse ];
                  })()), Halogen_HTML_Properties.id_(collapseId) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.cardBody, Halogen_Themes_Bootstrap4.textCenter ]) ])(content) ]) ]);
              };
          };
      };
  };
...
(function($PS) {
  ...
  var technicalSkills = Category.category("skills")("Technical skills")([ Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(CSS_Flexbox.justifyContent(CSS_Flexbox.spaceAround(CSS_Flexbox.spaceAroundJustifyContentValue))) ])(Data_Functor.map(Data_Functor.functorArray)(function (v) {
      return mkSkillLink(v.value0)(v.value1);
  })([ new Data_Tuple.Tuple("purescript", purescript), new Data_Tuple.Tuple("elm", elm), new Data_Tuple.Tuple("cpp", cpp), new Data_Tuple.Tuple("haskell", haskell), new Data_Tuple.Tuple("c", c), new Data_Tuple.Tuple("lua", lua), new Data_Tuple.Tuple("js", javascript), new Data_Tuple.Tuple("csharp", csharp), new Data_Tuple.Tuple("coffeescript", coffeescript), new Data_Tuple.Tuple("ruby", ruby), new Data_Tuple.Tuple("python", python), new Data_Tuple.Tuple("html", html), new Data_Tuple.Tuple("css", css), new Data_Tuple.Tuple("rust", rust) ])) ]);
...
(function($PS) {
  ...
  var languages = (function () {
      ...
      return Category.categoryHidden("languages")("Languages")([ Lists.listGroup(Data_Functor.map(Data_Functor.functorArray)(mkListItem)(langs)) ]);
  })();
...
(function($PS) {
  ...
  var Halogen_Themes_Bootstrap4 = $PS["Halogen.Themes.Bootstrap4"];
  var Lists = $PS["Lists"];                
  var scopeRow = Halogen_HTML_Properties.attr("scope")("row");
  var tableRow = function (title) {
      return function (content) {
          return Halogen_HTML_Elements.tr([ Halogen_HTML_Properties.class_("bio-table") ])([ Halogen_HTML_Elements.th([ scopeRow ])([ Halogen_HTML_Core.text(title) ]), Halogen_HTML_Elements.td_(content) ]);
      };
  };
...
(function($PS) {
  ...
  var projects = function (v) {
      ...
      if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Either.Right) {
          ...
          return Category.categoryHidden("projects")("Projects")([ Lists.listGroupC([ Halogen_Themes_Bootstrap4.textLeft ])(prjkts) ]);
      };
