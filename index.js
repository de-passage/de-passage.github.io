...
(function($PS) {
  ...
  var listItem = function (props) {
      var $9 = Halogen_HTML_Elements.li(Data_Array.snoc(props)(Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.listGroupItem)));
      return function ($10) {
          return ListItem($9($10));
      };
  };                             
  var listGroup = (function () {
      var $11 = Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.listGroup, Halogen_Themes_Bootstrap4.listGroupFlush ]) ]);
      var $12 = Data_Functor.map(Data_Functor.functorArray)(Data_Newtype.unwrap(newtypeListItem));
      return function ($13) {
          return $11($12($13));
      };
  })();                                                                      
  ...
  var category = function (id) {
      return function (title) {
          return function (content) {
              ...
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.card) ])([ Halogen_HTML_Elements.a([ collapseAttr, Halogen_HTML_Properties.href("#" + collapseId), Halogen_HTML_Properties_ARIA.role("button"), Halogen_HTML_Properties_ARIA.expanded("false"), Halogen_HTML_Properties_ARIA.controls(collapseId), Halogen_HTML_CSS.style(categoryTitleStyle) ])([ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.cardHeader ]) ])([ Halogen_HTML_Core.text(title) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.collapse, Halogen_Themes_Bootstrap4.show ]), Halogen_HTML_Properties.id_(collapseId) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.cardBody) ])(content) ]) ]);
          };
      };
  };
  ...
  var render = function (v) {
      var skill = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.colMd8, Halogen_Themes_Bootstrap4.colSm, Halogen_Themes_Bootstrap4.col12 ]) ])([ technicalSkills ]);
      var personal = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.colMd4, Halogen_Themes_Bootstrap4.colSm, Halogen_Themes_Bootstrap4.col12 ]) ])([ personalInformation ]);
