...
(function($PS) {
  ...
  var icon = function (name) {
      return Control_Bind.bind(Control_Bind.bindFn)(CSS_Size.em)(function (iconDimension) {
          ...
          var style = Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.padding(rem1)(rem1)(rem1)(rem1))(function () {
...
(function($PS) {
  ...
  var cite = function (v) {
      ...
      throw new Error("Failed pattern match at Content.Skills (line 399, column 1 - line 399, column 50): " + [ v.constructor.name ]);
  };
  var quote = function (v) {
      return function (content) {
          ...
          throw new Error("Failed pattern match at Content.Skills (line 404, column 1 - line 404, column 81): " + [ v.constructor.name, content.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var Category = $PS["Category"];
  var Lists = $PS["Lists"];                
  var projects = Category.categoryHidden("projects")("Projects")([ Lists.listGroup([ Lists.listItem_([  ]) ]) ]);
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(Resume.component)(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();