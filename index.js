...
(function($PS) {
  ...
  var cite = function (v) {
      ...
      throw new Error("Failed pattern match at Content.Skills (line 445, column 1 - line 445, column 50): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var languages = (function () {
      var mkListItem = function (v) {
          return Lists.listItem_([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.btn, "invisible-btn" ]), Attributes.dataToggle("modal"), Attributes.dataTarget("#modal" + v.value0), Halogen_HTML_Properties.title(v.value0) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.row) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.textLeft, Halogen_Themes_Bootstrap4.col ]) ])([ Halogen_HTML_Core.text(v.value0) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.textRight, Halogen_Themes_Bootstrap4.col ]) ])([ Halogen_HTML_Core.text(v.value1.value0) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.alignMiddle, "fa fa-info-circle" ]) ])([  ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.modal, Halogen_Themes_Bootstrap4.fade ]), Halogen_HTML_Properties.id_("modal" + v.value0), Halogen_HTML_Properties.tabIndex(-1 | 0), Attributes.dataBackdrop("static"), Halogen_HTML_Properties_ARIA.role("dialog"), Halogen_HTML_Properties_ARIA.labelledBy("backdropLabel" + v.value0), Halogen_HTML_Properties_ARIA.hidden("true") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.modalDialog, "modal-window" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalContent) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalHeader) ])([ Halogen_HTML_Elements.h3([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalTitle), Halogen_HTML_Properties.id_("backdropLabel" + v.value0) ])([ Halogen_HTML_Core.text(v.value0) ]), Halogen_HTML_Elements.h4([ Halogen_HTML_CSS.style(CSS_Geometry.marginTop(CSS_Common.auto(CSS_Size.autoSize))) ])([ Halogen_HTML_Core.text(v.value1.value0) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.modalBody, Halogen_Themes_Bootstrap4.textJustify ]) ])(v.value1.value1.value0), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalFooter) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.btn, Halogen_Themes_Bootstrap4.btnOutlinePrimary ]), Attributes.dataDismiss("modal"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropButtonType)(DOM_HTML_Indexed_ButtonType.ButtonButton.value) ])([ Halogen_HTML_Core.text("Close") ]) ]) ]) ]) ]) ]);
      };
...
(function($PS) {
  ...
  var personalInformation = (function () {
      ...
      return Category.category("personal")("Sylvain Leclercq")([ Lists.listGroup([ Lists.listItem([  ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.row) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.col ]) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.class_("profile-picture"), Halogen_HTML_Properties.src("/assets/me.jpg") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.col ]), Halogen_HTML_CSS.style(css) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties_ARIA.role("button"), Attributes.dataToggle("modal"), Attributes.dataTarget("#modalBio"), Halogen_HTML_Properties.title("Biography"), mkClass("info-circle"), Halogen_HTML_CSS.style(Control_Apply.applySecond(CSS_Stylesheet.applyStyleM)(linkStyle)(additionalStyle)) ])([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.modal, Halogen_Themes_Bootstrap4.fade ]), Halogen_HTML_Properties.id_("modalBio"), Halogen_HTML_Properties.tabIndex(-1 | 0), Attributes.dataBackdrop("static"), Halogen_HTML_Properties_ARIA.role("dialog"), Halogen_HTML_Properties_ARIA.labelledBy("backdropLabelBio"), Halogen_HTML_Properties_ARIA.hidden("true") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.modalDialog, "modal-window" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalContent) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalHeader) ])([ Halogen_HTML_Elements.h3([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalTitle), Halogen_HTML_CSS.style(CSS_Geometry.margin(CSS_Common.auto(CSS_Size.autoSize))(CSS_Common.auto(CSS_Size.autoSize))(CSS_Common.auto(CSS_Size.autoSize))(CSS_Common.auto(CSS_Size.autoSize))), Halogen_HTML_Properties.id_("backdropLabelBio") ])([ Halogen_HTML_Core.text("About me") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.modalBody, Halogen_Themes_Bootstrap4.textJustify ]) ])(aboutMe), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalFooter) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.btn, Halogen_Themes_Bootstrap4.btnOutlinePrimary ]), Attributes.dataDismiss("modal"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropButtonType)(DOM_HTML_Indexed_ButtonType.ButtonButton.value) ])([ Halogen_HTML_Core.text("Close") ]) ]) ]) ]) ]) ]) ]) ]), Lists.listItem([ Halogen_HTML_CSS.style(css) ])(Data_Array.snoc(Data_Functor.map(Data_Functor.functorArray)(socialMedia)(medias))(dl)) ]) ]);
  })();
...
(function($PS) {
  ...
  var mkErrorMsg = function (err) {
      return [ Lists.listItem_([ Halogen_HTML_Core.text(err) ]) ];
  };
  ...
  var projects = function (v) {
      ...
      if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Either.Left) {
          return Category.categoryHidden("projects")("Projects")([ Lists.listGroup(mkErrorMsg(Affjax.printError(v.value0.value0))) ]);
      };
      if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Either.Right) {
          var decodeThenMk = (function () {
              var $6 = Data_Either.either(mkErrorMsg)(Data_Functor.map(Data_Functor.functorArray)(mkProject));
              return function ($7) {
                  return $6(jsonToProject($7));
              };
          })();
          var parsed = Data_Argonaut_Parser.jsonParser(v.value0.value0);
...
(function($PS) {
  ...
  var render = function (state) {
      var skill = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.colMd8, Halogen_Themes_Bootstrap4.colSm7, Halogen_Themes_Bootstrap4.col12 ]) ])([ Work.workExperience, Content_Skills.technicalSkills, Projects.projects(state) ]);
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Affjax.get(Affjax_ResponseFormat.string)("https://api.github.com/users/de-passage/repos?sort=updated")))(function (response) {
              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(Data_Either.either(function ($6) {
                  return Data_Maybe.Just.create(Data_Either.Left.create($6));
              })(function ($7) {
                  return Data_Maybe.Just.create(Data_Either.Right.create((function (v1) {
                      return v1.body;
                  })($7)));
              })(response));
          });
