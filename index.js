...
(function($PS) {
  ...
  var resume = function (props) {
      return Halogen_HTML_Elements.a(Data_Semigroup.append(Data_Semigroup.semigroupArray)(props)([ Halogen_HTML_Properties.title("Download"), Halogen_HTML_Properties.href(Assets.resume), Halogen_HTML_Properties.download("Sylvain Leclercq"), Halogen_HTML_Properties.target("_blank") ]));
  };
  ...
  var personalInformation = (function () {
      ...
      var dl = resume([ mkClass("download"), Halogen_HTML_CSS.style(linkStyle) ])([  ]);
      ...
      })(aboutMe) ]) ]) ]), Lists.listItem([ Halogen_HTML_CSS.style(css) ])(Data_Array.snoc(Data_Functor.map(Data_Functor.functorArray)(socialMedia)(medias))(dl)) ]) ]);
  })();
