...
(function($PS) {
  ...
  var ruby = {
      ...
      content: Halogen_HTML_Elements.div_([  ])
  };
  var python = {
  ...
  var purescript = {
      ...
      content: Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Purescript is a strongly-typed functional programming language that compiles to JavaScript.") ])
  };
  var mkSkillLink = function (id) {
      return function (desc) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.card), Halogen_HTML_CSS.style(CSS_Display.display(CSS_Display.inlineBlock)) ])([ Halogen_HTML_Elements.button([ Attributes.dataToggle("modal"), Attributes.dataTarget("#modal" + id), Halogen_HTML_Properties.title(desc.title) ])([ desc.icon(7.0) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.modal, Halogen_Themes_Bootstrap4.fade ]), Halogen_HTML_Properties.id_("modal" + id), Halogen_HTML_Properties.tabIndex(-1 | 0), Attributes.dataBackdrop("static"), Halogen_HTML_Properties_ARIA.role("dialog"), Halogen_HTML_Properties_ARIA.labelledBy("backdropLabel" + id), Halogen_HTML_Properties_ARIA.hidden("true") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalDialog) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalContent) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalHeader) ])([ desc.icon(5.0), Halogen_HTML_Elements.h3([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalTitle), Halogen_HTML_CSS.style(CSS_Geometry.margin(CSS_Common.auto(CSS_Size.autoSize))(CSS_Common.auto(CSS_Size.autoSize))(CSS_Common.auto(CSS_Size.autoSize))(CSS_Common.auto(CSS_Size.autoSize))), Halogen_HTML_Properties.id_("backdropLabel" + id) ])([ Halogen_HTML_Core.text(desc.title) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalBody) ])([ desc.content ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.modalFooter) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.btn, Halogen_Themes_Bootstrap4.btnOutlinePrimary ]), Attributes.dataDismiss("modal"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropButtonType)(DOM_HTML_Indexed_ButtonType.ButtonButton.value) ])([ Halogen_HTML_Core.text("Close") ]) ]) ]) ]) ]) ]);
      };
  };
  var lua = {
      icon: Assets.luaIcon,
...
(function($PS) {
  ...
  var mkExperience = function (exp) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.textJustify ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.row ]) ])([ Halogen_HTML_Elements.h3([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.col, Halogen_Themes_Bootstrap4.mtAuto ]) ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href(exp.url) ])([ Halogen_HTML_Core.text(exp.company) ]) ]), Halogen_HTML_Elements.h4([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.col, Halogen_Themes_Bootstrap4.mtAuto ]) ])([ Halogen_HTML_Core.text(exp.job) ]) ]), Halogen_HTML_Elements.h4_([ Halogen_HTML_Core.text(exp.period) ]), Halogen_HTML_Elements.div_(exp.description) ]);
  };
