...
(function($PS) {
  ...
  var personalInformation = (function () {
      ...
      var dl = Halogen_HTML_Elements.a([ Halogen_HTML_Properties.title("Download"), Halogen_HTML_Properties.href(Assets.resume), Halogen_HTML_Properties.download("Sylvain Leclercq"), Halogen_HTML_Properties.target("_blank"), mkClass("download"), Halogen_HTML_CSS.style(linkStyle) ])([  ]);
      ...
      return Category.category("personal")("Sylvain Leclercq")([ Lists.listGroup([ Lists.listItem([  ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.row) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.col ]) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.class_("profile-picture"), Halogen_HTML_Properties.src("/assets/me.jpg") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.col ]), Halogen_HTML_CSS.style(css) ])([ Modal.modal("Bio")(function (a) {
