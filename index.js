...
(function($PS) {
  ...
  var listItem = function (props) {
      var $15 = Halogen_HTML_Elements.li(Data_Semigroup.append(Data_Semigroup.semigroupArray)(props)([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.listGroupItem) ]));
      return function ($16) {
          return ListItem($15($16));
      };
  };
  var listItem_ = listItem([  ]);
  var listGroup = (function () {
      var $20 = Halogen_HTML_Elements.ul([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.listGroup, Halogen_Themes_Bootstrap4.listGroupFlush ]) ]);
      var $21 = Data_Functor.map(Data_Functor.functorArray)(Data_Newtype.unwrap(newtypeListItem));
      return function ($22) {
          return $20($21($22));
      };
  })();                                                                      
      ...
      return function (id) {
          return function (title) {
              return function (content) {
                  ...
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.card) ])([ Halogen_HTML_Elements.a([ collapseAttr, Halogen_HTML_Properties.href("#" + collapseId), Halogen_HTML_Properties_ARIA.role("button"), Halogen_HTML_Properties_ARIA.expanded((function () {
                      if (b) {
                          return "true";
                      };
                      return "false";
  ...
  var languages = (function () {
      var mkListItem = function (v) {
          return listItem_([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("invisible-btn") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.row) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.textLeft, Halogen_Themes_Bootstrap4.col ]) ])([ Halogen_HTML_Core.text(v.value0) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.textRight, Halogen_Themes_Bootstrap4.col ]) ])([ Halogen_HTML_Core.text(v.value1) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([  ]) ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.classes([ "fa fa-info-circle" ]) ])([  ]) ]) ]) ]) ]);
      };
      var langs = [ new Data_Tuple.Tuple("French", "Native"), new Data_Tuple.Tuple("English", "Near Bilingual"), new Data_Tuple.Tuple("Japanese", "Fluent") ];
      ...
      return categoryHidden("languages")("Languages")([ listGroup(Data_Functor.map(Data_Functor.functorArray)(mkListItem)(langs)) ]);
  })();
  ...
  var personalInformation = (function () {
      ...
      return category("personal")("Sylvain Leclercq")([ listGroup([ listItem([ Halogen_HTML_CSS.style(css) ])(Data_Functor.map(Data_Functor.functorArray)(socialMedia)(medias)) ]) ]);
  })();
  var technicalSkills = category("skills")("Technical skills")([ Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(CSS_Flexbox.justifyContent(CSS_Flexbox.spaceAround(CSS_Flexbox.spaceAroundJustifyContentValue))) ])(Data_Functor.map(Data_Functor.functorArray)(function (v) {
      return mkSkillLink(v.value0)(v.value1);
  })([ new Data_Tuple.Tuple("purescript", Content_Skills.purescript), new Data_Tuple.Tuple("elm", Content_Skills.elm), new Data_Tuple.Tuple("cpp", Content_Skills.cpp), new Data_Tuple.Tuple("haskell", Content_Skills.haskell), new Data_Tuple.Tuple("c", Content_Skills.c), new Data_Tuple.Tuple("lua", Content_Skills.lua), new Data_Tuple.Tuple("js", Content_Skills.javascript), new Data_Tuple.Tuple("csharp", Content_Skills.csharp), new Data_Tuple.Tuple("coffeescript", Content_Skills.coffeescript), new Data_Tuple.Tuple("ruby", Content_Skills.ruby), new Data_Tuple.Tuple("python", Content_Skills.python), new Data_Tuple.Tuple("html", Content_Skills.html), new Data_Tuple.Tuple("css", Content_Skills.css) ])) ]);
  var render = function (v) {
      var skill = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.colMd8, Halogen_Themes_Bootstrap4.colSm7, Halogen_Themes_Bootstrap4.col12 ]) ])([ technicalSkills ]);
      var personal = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.colMd4, Halogen_Themes_Bootstrap4.colSm5, Halogen_Themes_Bootstrap4.col12 ]) ])([ personalInformation, languages ]);
