...
(function($PS) {
  ...
  var personalInformation = (function () {
      ...
      var additionalStyle = CSS_Geometry.margin(CSS_Common.auto(CSS_Size.autoSize))(CSS_Common.auto(CSS_Size.autoSize))(CSS_Common.auto(CSS_Size.autoSize))(CSS_Common.auto(CSS_Size.autoSize));
      return Category.category("personal")("Sylvain Leclercq")([ Lists.listGroup([ Lists.listItem([  ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.row) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.col ]) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.class_("profile-picture"), Halogen_HTML_Properties.src("/assets/me.jpg") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.col ]), Halogen_HTML_CSS.style(css) ])([ socialMediaS(info)(additionalStyle) ]) ]) ]), Lists.listItem([ Halogen_HTML_CSS.style(css) ])(Data_Array.snoc(Data_Functor.map(Data_Functor.functorArray)(socialMedia)(medias))(dl)) ]) ]);
  })();
...
(function($PS) {
  ...
  var projects = function (v) {
      ...
      if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Either.Left) {
          return Lists.listGroup(mkErrorMsg(Affjax.printError(v.value0.value0)));
      };
