          ...
          return function (title) {
              return function (content) {
                  ...
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.card) ])([ Halogen_HTML_Elements.a([ Attributes.collapseAttr, Halogen_HTML_Properties.href("#" + collapseId), Halogen_HTML_Properties_ARIA.role("button"), Halogen_HTML_Properties_ARIA.expanded((function () {
                      ...
                      return "false";
                  })()), Halogen_HTML_Properties_ARIA.controls(collapseId), Halogen_HTML_CSS.style(categoryTitleStyle) ])([ Halogen_HTML_Elements.h2([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.cardHeader ]) ])([ Halogen_HTML_Core.text(title) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes((function () {
                      if (b) {
...
(function($PS) {
  ...
  var personalInformation = (function () {
      ...
      return Category.category("personal")("Sylvain Leclercq")([ Lists.listGroup([ Lists.listItem([ Halogen_HTML_CSS.style(css) ])(Data_Functor.map(Data_Functor.functorArray)(socialMedia)(medias)) ]) ]);
  })();
