...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Internationalization"] = $PS["Internationalization"] || {};
  var exports = $PS["Internationalization"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Show = $PS["Data.Show"];                
  var En = (function () {
      function En() {
  ...
  var DownloadText = (function () {
      ...
      DownloadText.value = new DownloadText();
      return DownloadText;
  })();
  var Translate = function (translate) {
      this.translate = translate;
  };
  var translateLanguage = new Translate(function (v) {
      return function (v1) {
          if (v1 instanceof En) {
              return "English";
          };
          ...
          throw new Error("Failed pattern match at Internationalization (line 18, column 1 - line 21, column 30): " + [ v.constructor.name, v1.constructor.name ]);
      };
  });
  var translateDownloadText = new Translate(function (v) {
      return function (v1) {
          if (v instanceof En) {
              return "Download";
          };
          ...
          throw new Error("Failed pattern match at Internationalization (line 31, column 1 - line 34, column 28): " + [ v.constructor.name, v1.constructor.name ]);
      };
  });
  var translate = function (dict) {
      return dict.translate;
  };
  var supportedLanguages = [ En.value, Fr.value ];
  var showLanguage = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Internationalization (line 13, column 1 - line 16, column 17): " + [ v.constructor.name ]);
  });
  var eqLanguage = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof Jp && y instanceof Jp) {
              return true;
          };
          return false;
      };
  ...
  exports["translateDownloadText"] = translateDownloadText;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  ...
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var Internationalization = $PS["Internationalization"];                
  ...
  var resume = function (lang) {
      return resumeUrl(Data_Show.show(Internationalization.showLanguage)(lang));
  };
...
(function($PS) {
  ...
  var LanguageChanged = (function () {
      function LanguageChanged(value0) {
          this.value0 = value0;
      };
      LanguageChanged.create = function (value0) {
          return new LanguageChanged(value0);
      };
      return LanguageChanged;
  })();
  var languageSelection = function (currentLanguage) {
      var ddItem = function (lang) {
          return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.dropdownItem), Halogen_HTML_Properties.href("#"), Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(new LanguageChanged(lang));
          }) ])([ Halogen_HTML_Core.text(Internationalization.translate(Internationalization.translateLanguage)(currentLanguage)(lang)) ]);
      };
      var remainingLanguages = Data_Functor.map(Data_Functor.functorArray)(ddItem)(Data_Array["delete"](Internationalization.eqLanguage)(currentLanguage)(Internationalization.supportedLanguages));
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.dropdown) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.btn, Halogen_Themes_Bootstrap4.btnOutlinePrimary, Halogen_Themes_Bootstrap4.dropdownToggle ]), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropButtonType)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Properties.id_("languageSelectDropdown"), Halogen_HTML_Properties_ARIA.hasPopup("true"), Halogen_HTML_Properties_ARIA.expanded("false"), Halogen_HTML_Properties.attr("data-toggle")("dropdown") ])([ Halogen_HTML_Core.text(Internationalization.translate(Internationalization.translateLanguage)(currentLanguage)(currentLanguage)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.dropdownMenu), Halogen_HTML_Properties_ARIA.labelledBy("languageSelectDropdown") ])(remainingLanguages) ]);
  };
...
(function($PS) {
  ...
  var downloadWindow = function (model) {
      ...
      return [ Format.h2("Download resume as PDF"), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.row), padding ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.col6, Halogen_Themes_Bootstrap4.colSm2, Halogen_Themes_Bootstrap4.textCenter ]) ])([ State.languageSelection(model.language) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.col6, Halogen_Themes_Bootstrap4.colSm10, Halogen_Themes_Bootstrap4.textLeft ]) ])([ resume(model.language)([ Halogen_HTML_Properties.class_(Halogen_Themes_Bootstrap4.alignMiddle) ])([ Halogen_HTML_Core.text(Internationalization.translate(Internationalization.translateDownloadText)(model.language)(Internationalization.DownloadText.value)) ]) ]) ]), frame(model.language) ];
  };
  var blog = {
      title: "Blog",
      id: "pencil",
...
(function($PS) {
  ...
  var render = function (dictMonadAff) {
      return function (state) {
          ...
          var personal = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Halogen_Themes_Bootstrap4.colMd4, Halogen_Themes_Bootstrap4.colSm5, Halogen_Themes_Bootstrap4.col12 ]) ])([ Personal.personalInformation(state), Languages.languages ]);
  ...
  var component = function (dictMonadAff) {
      var initialState = {
          language: Internationalization.En.value
      };
